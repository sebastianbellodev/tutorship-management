CREATE DATABASE  IF NOT EXISTS `academictutorshipmanagement` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `academictutorshipmanagement`;
...
INSERT INTO `educationalprogramrole` VALUES (1,_binary '',2,1,'aarenas'),(2,_binary '',2,3,'aarenas'),(3,_binary '',2,3,'angesanchez'),(4,_binary '',2,2,'jocharan'),(5,_binary '',2,3,'jocharan'),(6,_binary '',2,3,'sauldominguez'),(7,_binary '',2,3,'juanmunoz');
...
-- Dump completed on 2023-04-19  9:39:12
