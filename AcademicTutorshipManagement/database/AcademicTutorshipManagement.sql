...
INSERT INTO `academicproblem` VALUES (2,'No sigue el plan de estudios de la experiencia educativa.','El profesor no imparte los saberes teóricos de la experiencia educativa ni brinda las herramientas educativas necesarias para el desarrollo del proyecto final, ocasionando que los estudiantes tengan conflictos académicos con otras experiencias educativas; por ejemplo, con Desarrollo de Sistemas en Red y Desarrollo de Aplicaciones.',4,85,1,NULL);
